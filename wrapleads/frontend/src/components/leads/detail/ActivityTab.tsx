...
const TYPE_LABELS: Record<ActivityType | string, { icon: ReactNode; label: string; color: string }> = {
  ...
  sms_sent:         { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>, label: 'SMS sent',            color: '#00d97e' },
  sms_received:     { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>, label: 'SMS received',        color: '#60a5fa' },
};
