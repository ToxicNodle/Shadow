...
const PROFILES = {
  ...
  '493120': {
    ...
    script_cfo: 'Your refrigeration is your single largest opex line item. A rooftop solar system locks in 40% of that cost at a fixed rate for 25 years — with full ITC + MACRS depreciation hitting your balance sheet in year one. Worth 15 minutes to see the model?',
    script_facilities: 'We specialize in cold-storage rooftop solar that installs without disrupting your temperature zones. Your roof membrane stays intact, and peak demand charges drop immediately. Can I walk you through how it works on a facility like yours?',
    script_sustainability: 'Cold storage is one of the highest-emitting commercial verticals — but also one of the easiest to decarbonize with rooftop solar. We can help you cut Scope 2 emissions 30-50% without changing operations. Worth a quick conversation?',
  },
  ...
  '518210': {
    ...
    script_cfo: 'A solar PPA lets you lock in below-grid power rates for your data center with zero capex — and it satisfies the renewable-energy clauses in your enterprise tenant SLAs. Can I send you a term sheet?',
    script_facilities: 'We design rooftop + carport solar specifically for data center thermal profiles — generation peaks exactly when cooling load peaks. No roof penetrations required. Quick call to review your facility layout?',
    script_sustainability: 'Enterprise tenants are demanding 100% renewable sourcing as a contract condition. A behind-the-meter PPA gets you there without carbon offsets or RECs. Want to see how it maps to your Scope 2 reporting?',
  },

  // ── HIGH-FIT: manufacturing (31-33) ──────────────────────────────────
  '311':    { fit: 88, load_profile: 'industrial_shift', energy_intensity: 'very_high', tax_appetite: 'corporate', ownership_model: 'direct_purchase', esg_pressure: 'high',    kwhDriver: 'food manufacturing — refrigeration + process heat', pitchHook: 'Food manufacturers face Tier-1 supplier ESG audits and continuous process loads — solar+storage cuts both peak demand charges and Scope 2 emissions.', sales_script: 'We work with food manufacturers under Scope 3 supplier pressure — solar usually answers two corporate mandates at once. Worth a quick conversation?', script_cfo: 'Your CPG buyers are auditing Scope 3 suppliers — solar gives you the compliance checkbox and a 4-5 year payback on the capex. Worth seeing the numbers?', script_facilities: 'We install on food manufacturing rooflines without disrupting USDA-certified operations. Peak production hours align perfectly with solar generation. Quick call?', script_sustainability: 'Tier-1 CPG suppliers are mandating Scope 3 disclosures — a rooftop system gets you ahead of the audit cycle. Can I show you how it maps to your reporting?' },
  ...
  '322':    { fit: 85, load_profile: 'flat_24_7',        energy_intensity: 'very_high', tax_appetite: 'corporate', ownership_model: 'direct_purchase', esg_pressure: 'high',    kwhDriver: 'pulp / paper / packaging — continuous high MW load', pitchHook: 'Pulp + paper sit in EPA carbon reporting boundaries — solar contracts can defer Scope 2 reporting requirements.', sales_script: 'Pulp & paper buyers are coming under intense ESG pressure from CPG brands — let\'s talk about a 1MW+ flat-roof system.', script_cfo: 'Your mill\'s energy bill is a top-3 line item. A 1MW+ rooftop system with full MACRS depreciation typically pays back in 4 years on a building this size. Worth running the numbers?', script_facilities: 'We design for continuous-process facilities — no production downtime during install, and your flat-roof footprint is ideal for maximum kW density. Quick call?', script_sustainability: 'EPA GHG reporters in pulp & paper are under increasing scrutiny. A large rooftop system directly reduces your Scope 2 emissions — real reductions, not offsets.' },
  ...
  '336':    { fit: 82, load_profile: 'industrial_shift', energy_intensity: 'very_high', tax_appetite: 'corporate', ownership_model: 'direct_purchase', esg_pressure: 'extreme', kwhDriver: 'transportation equipment / auto suppliers', pitchHook: 'OEMs are auditing Tier-1/2 suppliers on Scope 3 — solar PPA is the fastest way to satisfy without capex.', sales_script: 'OEMs are pushing carbon disclosures down to suppliers — we help auto/aerospace suppliers comply without breaking ground on capex. Worth talking?', script_cfo: 'OEM Scope 3 audits are adding real cost to non-compliant suppliers. A solar PPA gives you the green checkbox at zero capex — it shows up as an opex reduction, not a capex hit. Worth 15 minutes?', script_facilities: 'We install on manufacturing rooflines around shift schedules — daytime production matches solar generation almost perfectly. No downtime, no structural modifications. Quick call?', script_sustainability: 'Tier-1 auto and aerospace OEMs now require Scope 3 disclosures from suppliers. Rooftop solar is the fastest path to compliance without purchasing carbon offsets.' },

  // ── HIGH-FIT: warehousing & distribution (49) ────────────────────────
  '493110': { fit: 84, load_profile: 'daytime_peak', energy_intensity: 'moderate', tax_appetite: 'corporate', ownership_model: 'direct_purchase', esg_pressure: 'high',    kwhDriver: 'general warehousing — flat-roof palace', pitchHook: 'Massive flat-roof footprints are the most cost-efficient $/W commercial PV installs in the market.', sales_script: 'Distribution centers are the easiest commercial solar installs we do — large clear flat roofs, ground-level interconnect.', script_cfo: 'Large flat-roof warehouses have the lowest $/W install cost in commercial solar — we typically see 4-year payback after ITC + MACRS. Worth a quick site-specific estimate?', script_facilities: 'Your roof is the ideal solar substrate — large, flat, unobstructed. We install without disrupting warehouse operations and connect at ground-level switchgear. Quick call to walk through the layout?', script_sustainability: 'Warehouse Scope 2 emissions are an easy win — your flat-roof footprint generates enough solar to offset 60-80% of your grid consumption with zero operational changes.' },
  ...
  '4225':   { fit: 82, load_profile: 'daytime_peak', energy_intensity: 'moderate', tax_appetite: 'corporate', ownership_model: 'direct_purchase', esg_pressure: 'high',     kwhDriver: 'general warehousing & storage',  pitchHook: 'Built-to-last 30-year buildings match the solar payback horizon perfectly.', sales_script: 'Distribution facilities like yours often hit 4-5 year payback even before storage. Quick call to share numbers for your roof?', script_cfo: 'Your 30-year building matches the solar asset lifecycle perfectly. With ITC + MACRS, most distribution centers hit 4-year payback and generate positive cash flow from year one. Worth 15 minutes?', script_facilities: 'Your building is built for exactly this — large clear roof, accessible interconnect. We install during normal operations with zero disruption to loading docks or warehouse floor. Quick call?', script_sustainability: 'Distribution facilities are one of the easiest verticals to decarbonize. Your rooftop generates enough solar to offset 60%+ of grid consumption — a concrete Scope 2 win for sustainability reporting.' },
  ...
  '6111':   { fit: 72, load_profile: 'weekday_office',energy_intensity: 'moderate',  tax_appetite: 'tax_exempt', ownership_model: 'ppa',             esg_pressure: 'moderate', kwhDriver: 'K-12 schools — school-day load', pitchHook: 'Schools are tax-exempt — pitch a PPA where the installer owns the asset and the school buys kWh below grid rate.', sales_script: 'Schools can\'t use the federal tax credit directly — but a PPA gives you all the kWh, zero capex, locked-in rate. Want to see how it works?', script_cfo: 'A solar PPA locks in your electricity rate for 20+ years at below-grid prices — zero capex, it shows as an opex reduction on your budget. We handle the tax credit. Worth a conversation with your business office?', script_facilities: 'We design around school schedules — install during summer break, and the system generates maximum power during school-day hours when your HVAC load peaks. Quick call to discuss your campus?', script_sustainability: 'Solar-powered schools reduce emissions and create hands-on STEM learning opportunities. We\'ve helped districts turn their rooftops into both energy assets and teaching tools.' },
  ...
  '5312':   { fit: 70, load_profile: 'weekday_office', energy_intensity: 'moderate',tax_appetite: 'corporate',    ownership_model: 'direct_purchase', esg_pressure: 'high',    kwhDriver: 'lessors of nonresidential buildings', pitchHook: 'Portfolio-level deal — solar across multiple buildings, single procurement, tenant pass-through.', sales_script: 'CRE portfolios get a big ROI lift by stacking ITC across multiple buildings in one procurement. Worth a portfolio review?', script_cfo: 'Stacking ITC + MACRS across a multi-building portfolio amplifies the tax benefit per dollar invested. We model the whole portfolio — not just one roof. Worth a review?', script_facilities: 'We handle multi-site installs across your portfolio — single procurement, coordinated scheduling, one point of contact for every property. Quick call to scope the portfolio?', script_sustainability: 'GRESB and LEED benchmarks reward portfolio-level renewable energy procurement. Solar across your buildings is the most direct path to a higher sustainability score.' },
  ...
  '4451':   { fit: 75, load_profile: 'daytime_peak',  energy_intensity: 'high',     tax_appetite: 'corporate',    ownership_model: 'direct_purchase', esg_pressure: 'high',    kwhDriver: 'grocery stores — refrigeration', pitchHook: 'Refrigeration is your #1 line item — solar directly attacks demand charges.', sales_script: 'Grocery refrigeration drives the biggest demand charges in commercial real estate — solar usually cuts them 30%+. Quick call?', script_cfo: 'Refrigeration is your largest opex line. Solar + demand charge reduction typically saves 30%+ on your electricity bill with a 4-year payback after ITC. Worth seeing the model for your stores?', script_facilities: 'We design around your refrigeration load profile — peak demand aligns perfectly with solar generation. No disruption to cold-chain operations during install. Quick call?', script_sustainability: 'Grocery chains face growing consumer pressure on sustainability. Rooftop solar on your stores is the most visible, measurable step — and it directly cuts your biggest utility cost.' },
  ...
  '8131':   { fit: 60, load_profile: 'seasonal',      energy_intensity: 'moderate', tax_appetite: 'tax_exempt',   ownership_model: 'ppa',             esg_pressure: 'low',     kwhDriver: 'religious organizations — Sunday + event load', pitchHook: 'Churches can\'t use the federal ITC — a PPA gives you the kWh and a third-party owner monetizes the credit.', sales_script: 'For churches we recommend a Power Purchase Agreement — you pay below grid rate per kWh, the installer takes the tax credit. Most churches save 15-30% from day one.', script_cfo: 'A PPA means zero upfront cost to your congregation. You pay a locked-in rate below what you\'re paying the utility today — and the savings go straight to your general fund. Want to see the numbers?', script_facilities: 'We design around your event schedule — install during the week, and your Sunday peak load is covered. No modifications to your building structure. Quick call?', script_sustainability: 'Solar-powered houses of worship are a visible statement of stewardship values. Several denominations now recommend solar PPAs as part of their creation-care mandates.' },
  '92':     { fit: 70, load_profile: 'weekday_office',energy_intensity: 'moderate', tax_appetite: 'tax_exempt',   ownership_model: 'ppa',             esg_pressure: 'high',    kwhDriver: 'public administration / government', pitchHook: 'Municipal procurement + carbon goals + tax-exempt status → PPA or lease.', sales_script: 'Municipalities are required to publish renewable goals but can\'t use the ITC — let\'s talk about a PPA structure.', script_cfo: 'A solar PPA delivers below-grid rates locked in for 20+ years — predictable budget line item with zero capex. We handle RFP requirements and prevailing-wage compliance. Worth a conversation?', script_facilities: 'We install on government buildings around your operating schedule — parking structures, flat-roof admin buildings, fleet yards. Single point of contact, one procurement. Quick call?', script_sustainability: 'Most municipalities have published carbon-reduction targets. Solar on government buildings is the most direct, measurable action — and a PPA structure requires zero taxpayer capital.' },
